...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public long insertNote(String noteContent){
        ...
        ContentValues values = new ContentValues(); //puts the data into the respective columns
        values.put(COLUMN_NOTE_CONTENT, noteContent); //pass the input to the colummn
    ...
    public int updateNote(Note data){
        ...
        values.put(COLUMN_NOTE_CONTENT, data.getNoteContent()); //put in the values
